...
(function (global) {
  ...
  var ZH = {
    ...
    'src.presetPh': '选择内置预设源…',
    'toast.presetAdded': '已添加内置源：{0}',
    'src.expand': '展开该源的电台',
    'src.collapse': '收起该源的电台',
    'src.detailEmpty': '该源下暂无电台',
  ...
  var EN = {
    ...
    'src.presetPh': 'Pick a built-in preset…',
    'toast.presetAdded': 'Added built-in source: {0}',
    'src.expand': 'Expand stations in this source',
    'src.collapse': 'Collapse stations',
    'src.detailEmpty': 'No stations under this source',
